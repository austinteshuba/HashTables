//HashImage.java
//Austin Teshuba
//This class is a class for all images in the assignment. I took this from my simple game
...
public class HashImage {
	...
	public HashImage(BufferedImage i, int x1, int y1) {//initializes the class. takes in an image, an x and a y
